...
admin.site.site_header = "Luxus"
admin.site.site_title = "Luxus Admin Portal"
admin.site.index_title = "Luxus Admin"

# swagger
api_info = openapi.Info(
    title="Luxus API",
    default_version="v1",
    description="API documentation for Luxus App",
)
